...
export const SERVER_URL = process.env.NODE_ENV !== 'production' ? "http://127.0.0.1:8000" : "https://api.copomodoro.com";
...
export const ZOOM_LINK_URL = process.env.NODE_ENV !== 'production' ?
"https://zoom.us/oauth/authorize?client_id=gcmN37AQ2CFfbZbYZzmA&response_type=code&redirect_uri=https%3A%2F%2Flocalhost%3A3000%2Fzoom":
"https://zoom.us/oauth/authorize?response_type=code&client_id=Sq_MIXQcTGencegqaHAxtA&redirect_uri=https://copomodoro.com/zoom"